...
/**
 * MemorylessAugmentationQueryPrompt Class Doc Comment
 *
 * @category Class
 ...
 */
class MemorylessAugmentationQueryPrompt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemorylessAugmentationQuery_prompt';
    ...
    */
     ...
     *
     * @param string|null $prompt_template Prompt template to be used
     *
     * @return self
     */
     ...
     *
     * @param string|null $document_template Document context template to be used
     *
     * @return self
     */
