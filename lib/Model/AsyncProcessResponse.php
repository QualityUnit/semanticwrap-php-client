...
/**
 * AsyncProcessResponse Class Doc Comment
 *
 * @category Class
 * @package  Semanticwrap
 * @author   OpenAPI Generator team
 ...
 */
class AsyncProcessResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AsyncProcessResponse';
    ...
    */
     ...
     * Sets process_id
     *
     * @param string $process_id The process ID to get the response from
     *
     * @return self
     */
