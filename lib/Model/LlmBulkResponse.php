...
/**
 * LlmBulkResponse Class Doc Comment
 *
 * @category Class
 * @package  Semanticwrap
 * @author   OpenAPI Generator team
 ...
 */
class LlmBulkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LlmBulkResponse';
    ...
    protected static $openAPITypes = [
        ...
        'timing' => '\Semanticwrap\Model\LlmBulkResponseTiming'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['intermediate_results'] === null) {
            $invalidProperties[] = "'intermediate_results' can't be null";
        }
     ...
     *
     * @param string[] $intermediate_results The intermediate results
     *
     * @return self
     */
    public function setIntermediateResults($intermediate_results)
    {
        if (is_null($intermediate_results)) {
            throw new \InvalidArgumentException('non-nullable intermediate_results cannot be null');
        }
     ...
     * Gets timing
     *
     * @return \Semanticwrap\Model\LlmBulkResponseTiming
     */
     ...
     * Sets timing
     *
     * @param \Semanticwrap\Model\LlmBulkResponseTiming $timing timing
     *
     * @return self
     */
