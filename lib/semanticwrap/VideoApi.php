...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getYoutubeMicrodata'] to see the possible values for this operation
     *
     * @throws \Semanticwrap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Semanticwrap\Model\YoutubeMicrodataResponseModel|\Semanticwrap\Model\Error
     */
    public function getYoutubeMicrodata($video_id, $payload, string $contentType = self::contentTypes['getYoutubeMicrodata'][0])
    {
        list($response) = $this->getYoutubeMicrodataWithHttpInfo($video_id, $payload, $contentType);
        return $response;
    }

    /**
     * Operation getYoutubeMicrodataWithHttpInfo
     *
     * Get video microdata from Youtube API
     *
     ...
     * @throws \Semanticwrap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Semanticwrap\Model\YoutubeMicrodataResponseModel|\Semanticwrap\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getYoutubeMicrodataWithHttpInfo($video_id, $payload, string $contentType = self::contentTypes['getYoutubeMicrodata'][0])
    {
        $request = $this->getYoutubeMicrodataRequest($video_id, $payload, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Semanticwrap\Model\YoutubeMicrodataResponseModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Semanticwrap\Model\YoutubeMicrodataResponseModel' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Semanticwrap\Model\YoutubeMicrodataResponseModel', []),
            ...
            $returnType = '\Semanticwrap\Model\YoutubeMicrodataResponseModel';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Semanticwrap\Model\YoutubeMicrodataResponseModel',
    ...
    /**
     * Operation getYoutubeMicrodataAsync
     *
     * Get video microdata from Youtube API
     *
     * @param  string $video_id (required)
     ...
     */
    public function getYoutubeMicrodataAsync($video_id, $payload, string $contentType = self::contentTypes['getYoutubeMicrodata'][0])
    {
        return $this->getYoutubeMicrodataAsyncWithHttpInfo($video_id, $payload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getYoutubeMicrodataAsyncWithHttpInfo
     *
     * Get video microdata from Youtube API
     *
     * @param  string $video_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getYoutubeMicrodataAsyncWithHttpInfo($video_id, $payload, string $contentType = self::contentTypes['getYoutubeMicrodata'][0])
    {
        $returnType = '\Semanticwrap\Model\YoutubeMicrodataResponseModel';
        $request = $this->getYoutubeMicrodataRequest($video_id, $payload, $contentType);
    ...
    /**
     * Create request for operation 'getYoutubeMicrodata'
     *
     * @param  string $video_id (required)
     * @param  \Semanticwrap\Model\YoutubeMicrodataRequestModel $payload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getYoutubeMicrodata'] to see the possible values for this operation
     ...
     */
    public function getYoutubeMicrodataRequest($video_id, $payload, string $contentType = self::contentTypes['getYoutubeMicrodata'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling getYoutubeMicrodata'
            );
        }
        ...
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling getYoutubeMicrodata'
            );
        }


        $resourcePath = '/video/youtube_microdata/{video_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
