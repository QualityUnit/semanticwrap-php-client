...
/**
    ...
    /**
     * Operation updateDocumentByQuery
     *
     * Update a document by query
     *
     * @param  string $index_name index_name (required)
     * @param  \Semanticwrap\Model\UpdateDoc $payload payload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDocumentByQuery'] to see the possible values for this operation
     *
     * @throws \Semanticwrap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Semanticwrap\Model\Ack|\Semanticwrap\Model\Error
     */
    public function updateDocumentByQuery($index_name, $payload, string $contentType = self::contentTypes['updateDocumentByQuery'][0])
    {
        list($response) = $this->updateDocumentByQueryWithHttpInfo($index_name, $payload, $contentType);
        return $response;
    }

    /**
     * Operation updateDocumentByQueryWithHttpInfo
     *
     * Update a document by query
     *
     * @param  string $index_name (required)
     * @param  \Semanticwrap\Model\UpdateDoc $payload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDocumentByQuery'] to see the possible values for this operation
     *
     * @throws \Semanticwrap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Semanticwrap\Model\Ack|\Semanticwrap\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDocumentByQueryWithHttpInfo($index_name, $payload, string $contentType = self::contentTypes['updateDocumentByQuery'][0])
    {
        $request = $this->updateDocumentByQueryRequest($index_name, $payload, $contentType);
    ...
    /**
     * Operation updateDocumentByQueryAsync
     *
     * Update a document by query
     *
     * @param  string $index_name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDocumentByQueryAsync($index_name, $payload, string $contentType = self::contentTypes['updateDocumentByQuery'][0])
    {
        return $this->updateDocumentByQueryAsyncWithHttpInfo($index_name, $payload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateDocumentByQueryAsyncWithHttpInfo
     *
     * Update a document by query
     *
     * @param  string $index_name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDocumentByQueryAsyncWithHttpInfo($index_name, $payload, string $contentType = self::contentTypes['updateDocumentByQuery'][0])
    {
        $returnType = '\Semanticwrap\Model\Ack';
        $request = $this->updateDocumentByQueryRequest($index_name, $payload, $contentType);
    ...
    /**
     * Create request for operation 'updateDocumentByQuery'
     *
     * @param  string $index_name (required)
     * @param  \Semanticwrap\Model\UpdateDoc $payload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDocumentByQuery'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDocumentByQueryRequest($index_name, $payload, string $contentType = self::contentTypes['updateDocumentByQuery'][0])
    {

        // verify the required parameter 'index_name' is set
        if ($index_name === null || (is_array($index_name) && count($index_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $index_name when calling updateDocumentByQuery'
            );
        }
        ...
        if ($payload === null || (is_array($payload) && count($payload) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload when calling updateDocumentByQuery'
            );
        }


        $resourcePath = '/doc/_update_by_query/{index_name}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
