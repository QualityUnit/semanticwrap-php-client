...
*FineTunedApi* | [**memorylessAugmentV2**](docs/Api/FineTunedApi.md#memorylessaugmentv2) | **POST** /fine_tuned/memoryless/augment/{index_name} | Answers a given query from the documents in the index
...
- [SWAIModel](docs/Model/SWAIModel.md)
